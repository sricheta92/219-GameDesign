...
var scoreText ; 
var winText ; 
var messages = ["Lesson 1","Lesson 2","Lesson 3","Lesson 4"];
var messagesCount = 0;
...
Game.Level1.prototype = {
	...
	collisionHandlerForPlayer : function(player , enemy){
		this.resetPlayer() ; 
		winText = this.add.text(this.world.centerX , this.world.centerY , "You Lost!",  {font : '32px Arial' , fill : '#fff'} ) ;
		setInterval(function(){
			if(winText) winText.visible = false;
			winText = null;
		 }, 1000);
	...
	createEnemies : function(){
		...
		var tween = this.add.tween(enemy).to({y : 300 } , 2000 , Phaser.Easing.Linear.None, true , 0 , 1000, true);
		...
		var tween5 = this.add.tween(enemy5).to({y : 50 } , 2000 , Phaser.Easing.Linear.None, true , 0 , 1000, true);
